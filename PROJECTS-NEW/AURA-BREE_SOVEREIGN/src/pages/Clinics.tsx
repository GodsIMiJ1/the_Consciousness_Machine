      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <Card className="p-8 border-border bg-gradient-surface text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">
            Enhance Your Practice with Digital Mental Health Tools
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            We provide a no-PII pilot for mood trends and client engagement. 
            Help your clients build healthy habits between sessions.
          </p>
        </Card>
